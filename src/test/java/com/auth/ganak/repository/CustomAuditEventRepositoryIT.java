...
import com.auth.ganak.config.audit.AuditEventConverter;
import com.auth.ganak.domain.PersistentAuditEvent;
...
import static com.auth.ganak.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
