...
import com.auth.ganak.GanakApp;
import com.auth.ganak.config.Constants;
import com.auth.ganak.domain.Authority;
import com.auth.ganak.domain.PersistentToken;
import com.auth.ganak.domain.User;
import com.auth.ganak.repository.AuthorityRepository;
import com.auth.ganak.repository.PersistentTokenRepository;
...
import com.auth.ganak.service.dto.PasswordChangeDTO;
import com.auth.ganak.service.dto.UserDTO;
import com.auth.ganak.web.rest.errors.ExceptionTranslator;
import com.auth.ganak.web.rest.vm.KeyAndPasswordVM;
import com.auth.ganak.web.rest.vm.ManagedUserVM;
 ...
 */
@SpringBootTest(classes = GanakApp.class)
